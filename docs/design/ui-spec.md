...
- The bar is a compact single row and may be hidden. A floating restore control remains available without consuming layout height and signals background input requests.
