...
A new local session is temporary until its first accepted prompt or explicit rename. Replacing a selected temporary session closes it and excludes it from workspace persistence.
